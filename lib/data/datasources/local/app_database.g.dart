...
class ConversationRow extends DataClass implements Insertable<ConversationRow> {
  ...
  @override
  int get hashCode => Object.hash(id, title, pinned, createdAt, updatedAt);
  @override
...
class $MessagesTable extends Messages
  ...
  @override
  late final GeneratedColumnWithTypeConverter<ChatMessageStatus, String>
  status = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: true,
  ).withConverter<ChatMessageStatus>($MessagesTable.$converterstatus);
  ...
  static JsonTypeConverter2<ChatMessageStatus, String, String>
  $converterstatus = const EnumNameConverter<ChatMessageStatus>(
...
class $$MessagesTableFilterComposer
  ...
  ColumnWithTypeConverterFilters<ChatMessageStatus, ChatMessageStatus, String>
...
class $$MessagesTableAnnotationComposer
  ...
  GeneratedColumnWithTypeConverter<ChatMessageStatus, String> get status =>
